    ...
    <div className="signin-container">    
      <div className="text-center">
        <form className="form-signin" onSubmit={ props.handleLogin }>
          ...
          <input className="form-control username" name="username" type='username' placeholder='Username' onChange={ props.handleInputChange } />
          <input className="form-control password" name="password" type='password' placeholder='Password' onChange={ props.handleInputChange } />
