...
const generateShallowThumbnail = (percentageComplete = 0, uploadInitiated = false, uploadSuccess = false) => {
  return shallow(
    <Thumbnails key={1} handleCancel={jest.fn()} handleDelete={jest.fn()} index={1} 
    fileSize={123}
    fileName="mockTitle" 
...
const generateTreeThumbnail = (percentageComplete = 0, uploadInitiated = false, uploadSuccess = false) => {
